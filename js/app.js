(() => {
    ...
    function initSliders() {
        if (document.querySelector(".categories__slider")) new core(".categories__slider", {
            ...
            navigation: {
                prevEl: ".categories__arrow-right.swiper-button-prev",
                nextEl: ".categories__arrow-left.swiper-button-next"
            },
            breakpoints: {
                300: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".training__slider")) new core(".training__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 1e3,
            pagination: {
                el: ".training__swiper-pagination",
                clickable: true,
                dynamicBullets: true
            },
            navigation: {
                prevEl: ".training__arrow-right.swiper-button-prev",
                nextEl: ".training__arrow-left.swiper-button-next"
            },
            breakpoints: {
                300: {
                    slidesPerView: 1,
    ...
    da.init();
    const elements2 = document.querySelectorAll(".menu__list > li");
    function setDelay(array) {
        if (array.length) array.forEach(((element, index) => {
            element.style.transitionDelay = `${.1 * index}s`;
        }));
    }
    setDelay(elements2);
    window["FLS"] = true;
